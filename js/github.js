        ...
        card.innerHTML = `
            <div class="project-header">
                ...
                <div class="project-links">
                    <a href="${repo.html_url}" target="_blank" rel="noopener noreferrer" aria-label="Ver en GitHub" title="Ver en GitHub">
                    ...
                    <a href="${repo.html_url}" target="_blank" rel="noopener noreferrer" aria-label="Abrir proyecto" title="Abrir proyecto">
